...
<aside class="sidebar {open ? 'open' : 'collapsed'}">
	...
	<nav>
		...
		<footer class="footer {open ? 'visible' : 'hidden'}">
			<a href="https://www.nowaycode.com/projects/second-post" title="noway-code" target="_blank"
				 rel="noopener noreferrer">
				Blog Post
			</a>
			<a href="https://www.github.com/noway-code/TypeAlongSvelte" title="noway-code" target="_blank"
				 rel="noopener noreferrer">
				Source Code
			</a>
